    ...
    const html = `
        <div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1);">
            ...
            <div style="background: linear-gradient(135deg, #059669 0%, #10b981 100%); padding: 40px 20px; text-align: center; color: white;">
                ...
                <h1 style="margin: 0; font-size: 28px; font-weight: 700; letter-spacing: -0.025em; color: white;">Rent Received!</h1>
                <p style="margin: 10px 0 0; opacity: 0.9; font-size: 16px; color: white;">Good news! Your account has been credited.</p>
            </div>
            ...
            <div style="padding: 35px; background: #ffffff;">
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <a href="${process.env.FRONTEND_URL || 'http://localhost:5173'}/login" style="background: #059669; color: white; padding: 14px 32px; text-decoration: none; border-radius: 10px; font-weight: 600; font-size: 15px; display: inline-block;">View Transaction History</a>
                </div>
            </div>
            ...
            <div style="background: #f1f5f9; padding: 25px; text-align: center; font-size: 12px; color: #64748b; border-top: 1px solid #e2e8f0;">
                ...
                <p style="margin: 0;">&copy; ${new Date().getFullYear()} RentEase Inc.</p>
            </div>
        </div>
    `;
