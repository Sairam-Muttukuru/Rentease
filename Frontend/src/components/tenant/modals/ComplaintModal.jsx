...
const ComplaintModal = ({
    ...
    <div className="fixed inset-0 bg-black/80 z-50 flex items-start justify-center p-4 pt-20 backdrop-blur-sm animate-in fade-in duration-300 overflow-y-auto">
        <div className={`border rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl relative transition-all duration-500 mb-8 ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-white border-slate-200'}`}>
