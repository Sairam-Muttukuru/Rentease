                        ...
                        >
                            ...
                            <div className="relative px-8 pb-8 -mt-16 text-center">
                                ...
                                <div className="mt-6 flex items-center gap-3">
                                    ...
                                    <button onClick={() => onChatClick(tenant)} className={`p-3 rounded-xl border transition-all ${isDarkMode ? 'border-slate-700 hover:bg-slate-800 text-slate-400 hover:text-white' : 'border-slate-200 hover:bg-slate-100 text-slate-500 hover:text-indigo-600'}`}>
